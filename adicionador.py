...
pytesseract.pytesseract.tesseract_cmd = r'c:\Users\POSITIVO\AppData\Local\Programs\Python\Python312\Scripts\pytesseract.exe'  ##definindo o caminho até o pytesseract
...
for linha in tabela.index: 
    ...
    ##carregando a imagem
    foto_bytes.seek(0)
    imagem = Image.open(foto_bytes) ##abrindo e carregando a imagem
